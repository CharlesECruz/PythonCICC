...
def parenthesis_bit(string):
    ...
    if string[-1] == ")":
        parenthesis_bit(string[:-1])
    elif string[0] == "(":
        parenthesis_bit(string[1:])
        parenthesis_bit(string[1:])
    else:
        return parenthesis_bit(string[1:-1])
...
# Test recursion exercise

print(bunny_ears(50))
print(count_x("xoxoxoxoxo"))
print(no_x("xoxo"))
print(array_6([1, 4], 0))
print(all_star("abc"))
print(parenthesis_bit("xyz(abc)123"))
